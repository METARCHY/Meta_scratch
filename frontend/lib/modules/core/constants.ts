...
export const EVENTS: EventCardDefinition[] = [
    ...
    { id: 'revolution', title: 'REVOLUTION', flavor: 'The gears of history are turned by the blood of the oppressed.', desc: 'Compare Power. Player with the MOST Power wins Glory.', image: '/events/event_revolution.png', type: 'compare', targetResource: 'power', winCondition: 'max', reward: 'glory' },
